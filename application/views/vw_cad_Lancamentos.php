        ...
        <form class="form control " action="<?= base_url()?>Lancamentos/CadastraLancamento" method="post">
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" id="numero_doc_lancamento" name="numero_doc_lancamento"  placeholder="Número Documento" ></input>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <input type="date" class="form-control" id="data_lancamento" name="data_lancamento"  placeholder="00/00/0000" requered ></input>
                </div>

                <div class="col-md-2">
                    <label for="data_vencimento_lancamento">Data Vencimento: *</label>
                    <input type="date" class="form-control" id="data_vencimento_lancamento" name="data_vencimento_lancamento"  placeholder="00/00/0000" requered ></input>
                </div>
                <div class="col-md-2">
                    <label for="valor_lancamento">Valor:</label>
                    <div class="input-group">
                        <span class="input-group-addon">R$</span>
                        <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" name="valor_lancamento" id="valor_lancamento"placeholder="Valor Lançamento" value="">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
