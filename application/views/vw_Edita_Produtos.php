  ...
  <div class="row">
    <div class="col-md-12 ">
      <form class="form control " action="<?= base_url()?>Produtos_Servicos/SalvarEditProdutos" method="post">
        <input type="hidden" name="id_prod_serv" id="id_prod_serv" value="<?=$produtos[0]->id_prod_serv;?>">
        <div class="row">
          <div class="col-md-2">
            <label for="numero_prod">Código:</label>
            <input disabled="true" type="text" class="form-control" id="numero_prod" name="numero_prod"
        ...
        <div class="row">
          ...
          <div class="col-md-6 ">
            ...
            <textarea rows="3" cols="50" class="form-control"
              name="descricao_prod_serv"> <?=$produtos[0]->descricao_prod_serv;?> </textarea>
          </div>
        </div>
          <div class="row">
            <div class="col-md-12  ">
