    ...
    <div class="row">
        <form class="form control " action="<?= base_url()?>vendas/SalvarEditvendas" method="post">
                ...
                <div class="form-group">
                    ...
                    <select required class="form-control" id="cliente" name="cliente" >
                        ...
                        <?php foreach ($clientes as $d){?>
                            <option value="<?php echo $d->id_cliente ?>" <?php echo $d->id_cliente==$vendas[0]->id_cliente ?'selected':'';?> >
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" id="data_venda" name="data_venda"  placeholder="Data da Venda" value="<?=date('d/m/Y',strtotime($vendas[0]->data_venda));?>" required></input>
            </div>
            <div class="col-md-3">
                <label for="hora_venda">Hora Venda:</label>
                <input type="text" class="form-control" id="hora_venda" name="hora_venda"  placeholder="Hora da Venda" value="<?=date('H:i',strtotime($vendas[0]->data_venda));?>"required></input>
            </div>
            <br>
            </div>
            <br>
            ...
            <div class="col-md-6 ">
                ...
                <select required class="form-control" id="funcionario" name="funcionario">
                    ...
                    <?php foreach ($funcionarios as $d) : ?>
                        <option value="<?php echo $d->id_funcionario ?>" <?php echo $d->id_funcionario==$vendas[0]->id_funcionario ?'selected':'';?> >
