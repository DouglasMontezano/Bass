  ...
  <form class="form control " action="<?= base_url() ?>Vendas/CadastraVendas" method="post">
    <div class="row">
      ...
      <div class="col-md-3">
        ...
        <input type="date" class="form-control" id="data_venda" name="data_venda" placeholder="Data da Venda"
          required></input>
      </div>
      <div class="col-md-3">
        <label for="hora_cheg">Hora Venda:</label>
        <input type="time" class="form-control" id="hora_venda" name="hora_venda" placeholder="Hora da Venda"
          required></input>
      </div>
      <div class="col-md-6 ">
