      ...
      <tbody>
        ...
        <tr align=left>
          ...
          <td align= "center">
            ...
            <a href="<?= base_url('Vendas/ListProdServ/' . $obj->id_venda) ?>" class="btn btn-success btn-group"><i
                class="fa fa-eye" aria-hidden="true"></i> </a>
            <a href="<?= base_url('Vendas/FormEditVendas/' . $obj->id_venda) ?>" class="btn btn-info btn-group"><i
                class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
            <a href="<?= base_url('Vendas/ExcVendas/' . $obj->id_venda) ?>" class="btn btn-danger btn-group"
              onclick="return confirm('Deseja realmente excluir a Vendas?');"><i class="fa fa-trash"
                aria-hidden="true"></i>
            </a>
          </td>
        </tr>
