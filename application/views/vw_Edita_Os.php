    ...
    <div class="row">
      ...
      <div class="col-md-2">
        ...
        <input disabled="true" type="text" class="form-control" id="numero_os" name="numero_os"
          placeholder="código da OS" value="<?=$os[0]->id_os;?>"></input>
      </div>
      ...
      <div class="col-md-2">
        ...
        <input type="text" class="form-control" id="data_cheg" name="data_cheg"
          value="<?=date('d/m/Y', strtotime($os[0]->data_cheg));?>" placeholder="Data de Chegada" required></input>
      </div>
      <div class="col-md-2">
        <label for="hora_cheg">Hora Entrada:</label>
        <input type="text" class="form-control" id="hora_cheg" name="hora_cheg"
          value="<?=date('H:i', strtotime($os[0]->data_cheg));?>" placeholder="Hora de Entrada" required></input>
      </div>
      <div class="col-md-2">
        <label for="data_prev">Data Prevista:</label>
        <input type="text" class="form-control" id="data_prev" name="data_prev"
          value="<?=date('d/m/Y', strtotime($os[0]->data_prev));?>" placeholder="Data prevista para entrega"
          required></input>
      </div>
      <div class="col-md-2">
        <label for="data_fim">Data Entrega:</label>
        <input tYpe="date" class="form-control" id="data_fim" name="data_fim"
          value="<?=date('d/m/Y', strtotime($os[0]->data_entre));?>" placeholder="Data de Entrega"></input>
      </div>

      <div class="col-md-2">
        <label for="veiculo">Veículo:</label>
        <input type="text" class="form-control" id="veiculo" name="veiculo" value="<?=$os[0]->veiculo;?>"
          placeholder="Nome do Veiculo" required></input>
      </div>

      <div class="col-md-2">
        <label for="placa">Placa:</label>
        <input type="text" class="form-control" id="placa" name="placa" value="<?=$os[0]->placa;?>"
          placeholder="Placa do Veículo" required></input>
      </div>
