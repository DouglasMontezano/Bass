    ...
    <div class="col-md-12">
        ...
        <tbody>
            ...
            <td align="center">
                <a href="<?= base_url('Funcionarios/EditFuncionarios/' . $obj->id_funcionario) ?>"
                class="btn btn-info btn-group"><i class="fa fa-pencil" aria-hidden="true"></i> </a>
                <a href="<?= base_url('Funcionarios/ExcFuncionarios/' . $obj->id_funcionario) ?>"
                class="btn btn-danger btn-group" onclick="return confirm('Deseja realmente excluir o funcionário? ');"><i
