  ...
  <div class="col-md-12">
    ...
    <table class=" table table-striped table-dark table-bordered table-hover ">
      <thead>
        ...
        <tr>
          ...
          <th> Sub Total </th>
          <th><a id="btn" href="<?=base_url('Vendas/FormCadItensVendas/' . $resultado[0]->id_venda)?>"
              class="btn btn-info btn-group"> <i class="fa fa-plus" aria-hidden="true"></i> </a></th>
        </tr>
      </thead>
      <tbody>
        <?php $tot_venda = 0;?>
        ...
        <tr>
          ...
          <td>
            <a id="botoes"
              href="<?=base_url('Vendas/ExcItensVendas/' . $obj->id_item_venda . '/' . $resultado[0]->id_venda . '/' . $obj->valor_tot_item_venda)?>"
              class="btn btn-danger btn-group" onclick="return confirm('Deseja realmente excluir este ítem');"> <i
    ...
    <div class="row">
      <div class="col-md-7">
        ...
        <h3><strong>
            <font color="#40e0d0">Venda Finalizada</font>
          </strong></h3>
