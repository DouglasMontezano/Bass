    ...
    <div class="row">
        <form class="form control " action="<?= base_url()?>vendas/SalvarEditvendas" method="post">
            ...
            <div class="col-md-2">
                ...
                <input disabled="true" type="text" class="form-control" id="tipo_venda" name="tipo_venda"   value="<?=$vendas[0]->tipo_venda;?>"></input>
            </div>

            <div class="col-md-2">
                    <label for="situacao">Situação:</label>
                    <input disabled="true" type="text" class="form-control" id="situacao_venda" name="situacao_venda"   value="<?=$vendas[0]->situacao_venda;?>"></input>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-6 ">
                    ...
                    <input disabled="true" type="text" class="form-control" id="nome_cliente" name="nome_cliente"  placeholder="nome_cliente" value="<?=$vendas[0]->nome_cliente;?>"></input>
            </div>
            <div class="col-md-6 ">
