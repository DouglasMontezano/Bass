...
<div class="container container fluid ">
    <div class="row">
        <div class= "col-md-12 ">
            <h2 >Lancamento da O.S Nº: <?php echo $cod_os;?></h2><br>
    ...
    <form class="form control " action="<?= base_url()?>Lancamentos/CadastraLancamento" method="post">
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <input type="text" class="form-control" id="id_os" name="id_os"  value="<?= $cod_os;?>" placeholder="Código da O.S" ></input>
            </div>
            <div class="col-md-2">
                <label for="id_venda">Codigo Venda:</label>
                <input disabled type="text" class="form-control" id="id_venda" name="id_venda"  placeholder="Código da venda" ></inputdisabled>
            </div>
            <div class="col-md-2 ">
        ...
        <div class="row">
            ...
            <div class="col-md-2 ">
                ...
                <div class="radio">
                    <label><input type="radio" name="subtipo_lancamento" value="O.S"
                            <?php echo ($subtipo_lancamnto == "O.S") ? "checked" : null; ?>>O.S</label>
                </div>
                <div class="radio">
            ...
            <div class="col-md-2">
                ...
                <input type="text" class="form-control" id="data_lancamento" name="data_lancamento"
                       value="<?= date('d/m/Y');?>" placeholder="00/00/0000" required >
                </input>
            </div>
