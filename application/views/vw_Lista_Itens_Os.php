            ...
            <div class="col-md-12">
              ...
              <table class=" table table-striped table-dark table-bordered table-hover ">
                <thead>
                  <tr>
                    ...
                    <th> Sub Total </th>
                    <th> <a href="<?=base_url('Os/FormCadItensOs/' . $resultado[0]->id_os)?>"
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?=base_url('Os/ExcItensOs/' . $obj->id_item . '/' . $resultado[0]->id_os) . '/' . $obj->valor_tot_item?>"
                        class="btn btn-danger btn-group"
                        onclick="return confirm('Deseja realmente excluir este ítem');"> <i class="fa fa-trash"
                          aria-hidden="true"></i>
                      </a>
                    </td>
                  </tr>
              ...
              <div class="row">
                <div class="col-md-7">
                  ...
                  <h3><strong>
                      <font color="#008888">Ordem de Serviço Finalizada</font>
                    </strong></h3>
                ...
                <div class="col-md-5">
                  <h2 class="valortot">Valor Total:<?php echo ' R$ ' . number_format($tot_os, 2, ',', '.'); ?></h2>
                </div>
              </div>
            </div>
          <!-- </div> -->
